...
<center>
        ...
        <%
           ...
           // Object o= session.getAttribute("com");
            user = session.getAttribute("com").toString();
            ...
            ResultSet rs = st.executeQuery("SELECT Email,code FROM business WHERE Email='" + user + "' AND code='" + code + "'");
                 if (rs.next()) {
                 
                    response.sendRedirect("breg_success.jsp");
                 }

             else {
                response.sendRedirect("bcom_error.jsp");
