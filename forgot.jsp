...
return false;
      ...
      <h1>Get Password Of Your Account</h1>
      <form name="form" method="post" action="forgot_rply.jsp">
      <div class="reg_section personal_info">
    
      <input type="text" name="user" value="" placeholder="Enter Username" required>
      <input type="text" name="mail" value="" placeholder="Enter Your Email ID" required>
      </div>
      <p class="submit"><center><input type="submit" name="commit" value="Get Password"></p>
      </form>
    </section>
  </div>
