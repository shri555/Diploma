...
<html>
    <head>
        ...
        <script src="js/modernizr.cust om.63321.js"></script>
        <style>	
            body {
    ...
    <% session.setAttribute("id", request.getParameter("Doc_id"));%>
    ...
    %> 
    <section class="main">
        <form class="form-4" method="post" action="share_rply.jsp">
            <h1>Enter Username Of User To Share File</h1>
            <p>
                <label for="share">Username</label>
                <input type="text" name="share" placeholder="Username" required>
            </p>
        ...
        <div class="logo fl-rt"> <a href="user.jsp">See Registered Users</a></div>
    </section>
