    ...
    <center>
        <table style="width:80%">
            ...
            <% 
                ...
                ResultSet rs = MyConnection.getResultFromSqlQuery("select receiver,msg,s_time,id from sent_msg where sender='"+s+"'");
                int count =0;
                while(rs.next())
                {
                    ++count;   
                    if(count==1)
                        out.print("<tr> <th colspan='4'>To</th><th colspan='4'>Message</th><th colspan='4'>Time</th><th colspan='4'>Delete</th></tr><br/>");
            
                   out.println("<tr>"
                           + "<td colspan='4'>"+rs.getString(1)+"</td>"
                           + "<td colspan='4'>"+rs.getString(2)+"</td>"
                           + "<td colspan='4'>"+rs.getString(3)+"</td>"
                           + "<td colspan='4'><a href='del_smsg.jsp?id="+rs.getInt(4) +"'> Delete </a></td>"
                           + "</tr>"+"<br>");
