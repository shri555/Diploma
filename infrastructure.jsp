...
<html>
    ...
    %>
        ...
        <form action="upload.jsp" class="form-4"><input type="submit" name="submit" value="Upload File"></form>
  
        <form action="delete.jsp" class="form-4"><input type="submit" name="submit" value="Delete File"> </form>
  
  
   <form action="download.jsp" class="form-4"><input type="submit" name="submit" value="Download File"></form>
        <form action="share.jsp" class="form-4"><input type="submit" name="submit" value="Share File"> </form>
        <form action="shared.jsp" class="form-4"><input type="submit" name="submit" value="See Shared File"> </form>
  
        </section> 
    <div class="contact"><br><center>
<form action="services.jsp"><input type="submit" value="Back" name="back" /> </form>
 </div>
    </body>
</html>