...
return false;
      ...
      <h1>Change Username Of Your Account</h1>
      <form name="form" method="post" action="user_rply.jsp">
      <div class="reg_section personal_info">
    
      <input type="text" name="new_u" value="" placeholder="Enter New Username" required>
      <input type="text" name="mail" value="" placeholder="Enter Your Email ID" required>
      </div>
      <p class="submit"><center><input type="submit" name="commit" value="Change UserName"></p>
      </form>
    </section>
  </div>
