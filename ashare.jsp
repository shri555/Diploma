        ...
        <table style="width:80%">
               <% 
                ...
                while(rs.next())
                {
                    ++count;   
                    if(count==1)
                        out.print("<tr><th>File Name</th><th>File Type</th><th>Upload Time</th><th>Action</th></tr><br/><br/>");
            
                   out.println("<tr>"
                           + "<td>"+rs.getString(2)+"</td>"
                           + "<td>"+rs.getString(3)+"</td>"
                           + "<td>"+rs.getString(4)+"</td>"
                           + "<td><a href='sshare.jsp?Doc_id="+rs.getInt(1) +"'> Share </a></td>"                                                      
                           + "</tr>"+"<br>");
