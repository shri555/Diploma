...
<html>
    ...
    %>
        ...
        <form action="html_view.jsp" class="form-4"><input type="submit" name="submit" value="HTML Viewer"></form>
  
        <form action="msg.jsp" class="form-4"><input type="submit" name="submit" value="Messaging"> </form>
